...
* <pre>
* var SprintApi = require('index'); // See note below*.
* var xxxSvc = new SprintApi.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new SprintApi.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new SprintApi.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new SprintApi.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
