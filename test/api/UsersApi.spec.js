...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NodeExpressBoilerplateApiDocumentation.UsersApi();
  });
  ...
  describe('UsersApi', function() {
    ...
    describe('usersIdPatch', function() {
      it('should call usersIdPatch successfully', function(done) {
        //uncomment below and update the code to test usersIdPatch
        //instance.usersIdPatch(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
