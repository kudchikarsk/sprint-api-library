...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SprintService.AuthTokens();
  });
  ...
  describe('AuthTokens', function() {
    it('should create an instance of AuthTokens', function() {
      ...
      //var instane = new SprintService.AuthTokens();
      //expect(instance).to.be.a(SprintService.AuthTokens);
    });
    ...
    it('should have the property access (base name: "access")', function() {
      ...
      //var instance = new SprintService.AuthTokens();
