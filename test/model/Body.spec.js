...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NodeExpressBoilerplateApiDocumentation.Body();
  });
  ...
  describe('Body', function() {
    it('should create an instance of Body', function() {
      ...
      //var instane = new NodeExpressBoilerplateApiDocumentation.Body();
      //expect(instance).to.be.a(NodeExpressBoilerplateApiDocumentation.Body);
    });
