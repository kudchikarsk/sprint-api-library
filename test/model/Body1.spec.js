...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NodeExpressBoilerplateApiDocumentation.Body1();
  });
  ...
  describe('Body1', function() {
    it('should create an instance of Body1', function() {
      ...
      //var instane = new NodeExpressBoilerplateApiDocumentation.Body1();
      //expect(instance).to.be.a(NodeExpressBoilerplateApiDocumentation.Body1);
    });
