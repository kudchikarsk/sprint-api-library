...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SprintService.Body10();
  });
  ...
  describe('Body10', function() {
    it('should create an instance of Body10', function() {
      ...
      //var instane = new SprintService.Body10();
      //expect(instance).to.be.a(SprintService.Body10);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new SprintService.Body10();
