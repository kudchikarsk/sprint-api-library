...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SprintService.Body12();
  });
  ...
  describe('Body12', function() {
    it('should create an instance of Body12', function() {
      ...
      //var instane = new SprintService.Body12();
      //expect(instance).to.be.a(SprintService.Body12);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new SprintService.Body12();
