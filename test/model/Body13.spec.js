...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SprintService.Body13();
  });
  ...
  describe('Body13', function() {
    it('should create an instance of Body13', function() {
      ...
      //var instane = new SprintService.Body13();
      //expect(instance).to.be.a(SprintService.Body13);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new SprintService.Body13();
