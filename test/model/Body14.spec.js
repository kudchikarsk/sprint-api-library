...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SprintService.Body14();
  });
  ...
  describe('Body14', function() {
    it('should create an instance of Body14', function() {
      ...
      //var instane = new SprintService.Body14();
      //expect(instance).to.be.a(SprintService.Body14);
    });
    ...
    it('should have the property teamId (base name: "teamId")', function() {
      ...
      //var instance = new SprintService.Body14();
      //expect(instance).to.be();
    });

    it('should have the property backlogId (base name: "backlogId")', function() {
      // uncomment below and update the code to test the property backlogId
      //var instance = new SprintService.Body14();
      //expect(instance).to.be();
    });
