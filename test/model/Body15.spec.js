...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SprintService.Body15();
  });
  ...
  describe('Body15', function() {
    it('should create an instance of Body15', function() {
      ...
      //var instane = new SprintService.Body15();
      //expect(instance).to.be.a(SprintService.Body15);
    });
    ...
    it('should have the property teamId (base name: "teamId")', function() {
      ...
      //var instance = new SprintService.Body15();
