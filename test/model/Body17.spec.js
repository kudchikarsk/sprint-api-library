...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SprintService.Body17();
  });
  ...
  describe('Body17', function() {
    it('should create an instance of Body17', function() {
      ...
      //var instane = new SprintService.Body17();
      //expect(instance).to.be.a(SprintService.Body17);
    });
    ...
    it('should have the property teamId (base name: "teamId")', function() {
      ...
      //var instance = new SprintService.Body17();
