...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SprintService.Body18();
  });
  ...
  describe('Body18', function() {
    it('should create an instance of Body18', function() {
      ...
      //var instane = new SprintService.Body18();
      //expect(instance).to.be.a(SprintService.Body18);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new SprintService.Body18();
