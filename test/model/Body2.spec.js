...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NodeExpressBoilerplateApiDocumentation.Body2();
  });
  ...
  describe('Body2', function() {
    it('should create an instance of Body2', function() {
      ...
      //var instane = new NodeExpressBoilerplateApiDocumentation.Body2();
      //expect(instance).to.be.a(NodeExpressBoilerplateApiDocumentation.Body2);
    });
