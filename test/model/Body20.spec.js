...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SprintService.Body20();
  });
  ...
  describe('Body20', function() {
    it('should create an instance of Body20', function() {
      ...
      //var instane = new SprintService.Body20();
      //expect(instance).to.be.a(SprintService.Body20);
    });
    ...
    it('should have the property teamId (base name: "teamId")', function() {
      ...
      //var instance = new SprintService.Body20();
