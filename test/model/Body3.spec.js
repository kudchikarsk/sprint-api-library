...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NodeExpressBoilerplateApiDocumentation.Body3();
  });
  ...
  describe('Body3', function() {
    it('should create an instance of Body3', function() {
      ...
      //var instane = new NodeExpressBoilerplateApiDocumentation.Body3();
      //expect(instance).to.be.a(NodeExpressBoilerplateApiDocumentation.Body3);
    });
