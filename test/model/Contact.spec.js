...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SprintService.Contact();
  });
  ...
  describe('Contact', function() {
    it('should create an instance of Contact', function() {
      ...
      //var instane = new SprintService.Contact();
      //expect(instance).to.be.a(SprintService.Contact);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new SprintService.Contact();
