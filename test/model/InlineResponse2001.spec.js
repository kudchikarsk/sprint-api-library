...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SprintService.InlineResponse2001();
  });
  ...
  describe('InlineResponse2001', function() {
    it('should create an instance of InlineResponse2001', function() {
      ...
      //var instane = new SprintService.InlineResponse2001();
      //expect(instance).to.be.a(SprintService.InlineResponse2001);
    });

    it('should have the property results (base name: "results")', function() {
      // uncomment below and update the code to test the property results
      //var instance = new SprintService.InlineResponse2001();
