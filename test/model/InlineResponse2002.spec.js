...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SprintService.InlineResponse2002();
  });
  ...
  describe('InlineResponse2002', function() {
    it('should create an instance of InlineResponse2002', function() {
      ...
      //var instane = new SprintService.InlineResponse2002();
      //expect(instance).to.be.a(SprintService.InlineResponse2002);
    });

    it('should have the property results (base name: "results")', function() {
      // uncomment below and update the code to test the property results
      //var instance = new SprintService.InlineResponse2002();
