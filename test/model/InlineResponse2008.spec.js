...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SprintService.InlineResponse2008();
  });
  ...
  describe('InlineResponse2008', function() {
    it('should create an instance of InlineResponse2008', function() {
      ...
      //var instane = new SprintService.InlineResponse2008();
      //expect(instance).to.be.a(SprintService.InlineResponse2008);
    });

    it('should have the property results (base name: "results")', function() {
      // uncomment below and update the code to test the property results
      //var instance = new SprintService.InlineResponse2008();
