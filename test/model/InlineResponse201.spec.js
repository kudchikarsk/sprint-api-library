...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SprintService.InlineResponse201();
  });
  ...
  describe('InlineResponse201', function() {
    it('should create an instance of InlineResponse201', function() {
      ...
      //var instane = new SprintService.InlineResponse201();
      //expect(instance).to.be.a(SprintService.InlineResponse201);
    });

    it('should have the property user (base name: "user")', function() {
      // uncomment below and update the code to test the property user
      //var instance = new SprintService.InlineResponse201();
