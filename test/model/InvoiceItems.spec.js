...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SprintService.InvoiceItems();
  });
  ...
  describe('InvoiceItems', function() {
    it('should create an instance of InvoiceItems', function() {
      ...
      //var instane = new SprintService.InvoiceItems();
      //expect(instance).to.be.a(SprintService.InvoiceItems);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new SprintService.InvoiceItems();
