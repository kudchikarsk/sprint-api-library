...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SprintService.Organization();
  });
  ...
  describe('Organization', function() {
    it('should create an instance of Organization', function() {
      ...
      //var instane = new SprintService.Organization();
      //expect(instance).to.be.a(SprintService.Organization);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new SprintService.Organization();
