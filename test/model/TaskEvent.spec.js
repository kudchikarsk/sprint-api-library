...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SprintService.TaskEvent();
  });
  ...
  describe('TaskEvent', function() {
    it('should create an instance of TaskEvent', function() {
      ...
      //var instane = new SprintService.TaskEvent();
      //expect(instance).to.be.a(SprintService.TaskEvent);
    });

    it('should have the property type (base name: "type")', function() {
      // uncomment below and update the code to test the property type
      //var instance = new SprintService.TaskEvent();
