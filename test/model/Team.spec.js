...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NodeExpressBoilerplateApiDocumentation.Team();
  });
  ...
  describe('Team', function() {
    it('should create an instance of Team', function() {
      ...
      //var instane = new NodeExpressBoilerplateApiDocumentation.Team();
      //expect(instance).to.be.a(NodeExpressBoilerplateApiDocumentation.Team);
    });
